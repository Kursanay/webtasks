...
<form action="week10_task3.php">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <div>
                    <label><input type="checkbox" name="att1" value="yes" <?php if($selected_car['additional']!=null){if(in_array("tax", $selected_car['additional'])){echo ' checked ';}}?>>tax payed</label>
                    <label><input type="checkbox" name="att2" value="yes" <?php if($selected_car['additional']!=null){if(in_array('check', $selected_car['additional'])){echo ' checked ';}} ?>>technical check passed</label>
                    <label><input type="checkbox" name="att3" value="yes" <?php if($selected_car['additional']!=null){if(in_array('investment', $selected_car['additional'])){echo ' checked ';}} ?>>does not require investment</label>
                </div>
            </td>
        </tr>
        <tr>
